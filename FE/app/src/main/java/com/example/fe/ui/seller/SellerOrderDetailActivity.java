...
public class SellerOrderDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // sử dụng constructor mới: (name, price, imageUrl, imageRes, category, sku, qty, unitPrice)
        products.add(new ProductModel("Lipstick Red", "$55.00", null, R.drawable.img_deal_4, null, "LIP-RED-01", 2, 55.00));
        products.add(new ProductModel("Moisturizer", "$60.00", null, R.drawable.img_moisturizer, null, "MOIS-002", 1, 60.00));
     ...
     static class ProductAdapter extends RecyclerView.Adapter<ProductAdapter.ProductVH> {
         ...
         public void onBindViewHolder(ProductVH holder, int position) {
             try {
                 ...
                 // load image: prefer imageUrl then imageRes fallback
                 if (holder.img != null) {
